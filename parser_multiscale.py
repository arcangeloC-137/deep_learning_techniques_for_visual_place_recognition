...
def parse_arguments():
    ...
    #parameters added for the multiscale testing
    parser.add_argument("--multiscale", type=str, default=False, help='Set this to true if multiscale testing is desired')
    parser.add_argument("--step_multiscale", type=int, default=[2,3,4], help='parameter used to resize the images, 2 means half the dimensions')
    parser.add_argument("--multiscale_method", type=str, default="concat", help='Set concat to concatenate descriptors and average to average descriptors for multiscale testing')
