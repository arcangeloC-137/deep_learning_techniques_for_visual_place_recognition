...
import commons
import datasets_ws
from model import network_ensemble
...
#### Initialize model
modelA = network_ensemble.modelA(args)
modelB = network_ensemble.modelB(args)
model = network_ensemble.MyEnsemble(modelA,modelB)
