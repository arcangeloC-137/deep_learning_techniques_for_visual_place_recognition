...
import util
import test
import parser_ensemble 
import commons
import datasets_ws
from model import network_ensemble_addition
from model.sync_batchnorm import convert_model
from model.functional import sare_ind, sare_joint

#### Initial setup: parser, logging...
args = parser_ensemble.parse_arguments()
...
#modep = datasets_ws.mod("ensemble")
...
#### Initialize model
modelA = network_ensemble_addition.modelA(args)
modelB = network_ensemble_addition.modelB(args)
model = network_ensemble_addition.MyEnsemble(modelA,modelB)
...
if args.aggregation in ["netvlad", "crn"]:  # If using NetVLAD layer, initialize it
    if not args.resume:
        ...
        print("HERE")
        modelA.aggregation.initialize_netvlad_layer(args, triplets_ds, modelA.backbone1)
        modelB.aggregation.initialize_netvlad_layer(args, triplets_ds, modelB.backbone2)
