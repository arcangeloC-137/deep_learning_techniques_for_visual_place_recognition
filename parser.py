...
def parse_arguments():
    ...
    # Data augmentation Perspective Changes and Occlusions
    parser.add_argument("--perspective_fill_data_augmentation", type=bool, default=False)
    parser.add_argument("--perspective_crop_data_augmentation", type=bool, default=False)
    parser.add_argument("--occlusion_data_augmentation", type=bool, default=False)
    parser.add_argument("--perspective_prob", type=float, default=None, help="_")
    parser.add_argument("--distortion_scale", type=float, default=None, help="_")
    parser.add_argument("--occlusion_prob", type=float, default=None, help="_")
    parser.add_argument("--perspective_fill", type=float, default=None, help="_")
    parser.add_argument("--height_crop", type=int, default=None, help="_")
    parser.add_argument("--width_crop", type=int, default=None, help="_")

    # 'Smart' Data augmentation parameters
    parser.add_argument("--night_data_augmentation", type=bool, default=False)
    parser.add_argument("--adjust_brightness", type=float, default=None, help="adjust_brightness param: 1 -> same img, 0 -> black")
    parser.add_argument("--solarize", type=float, default=None, help="threshold (float) All pixels equal or above this value are inverted.")
